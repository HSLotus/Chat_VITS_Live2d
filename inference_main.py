...
def inf_main():
    ...
    # Required
    parser.add_argument('-m', '--model_path', type=str, default="logs/44k/G_68800.pth",
                        help='Path to the model.')
    parser.add_argument('-c', '--config_path', type=str, default="configs/config.json",
                        help='Path to the configuration file.')
    parser.add_argument('-s', '--spk_list', type=str, nargs='+', default=['Lapland'],
                        help='Target speaker name for conversion.')
    parser.add_argument('-n', '--clean_names', type=str, nargs='+', default=["out.wav"],
    ...
    svc_model = infer_tool.Svc(args.model_path, args.config_path, args.device, args.cluster_model_path,enhance)
